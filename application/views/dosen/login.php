...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>aceadmin/node_modules/bootstrap/dist/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?php echo base_url() ?>aceadmin/fonts/fontello/css/fontello.css" />
    <link rel="stylesheet" href="<?php echo base_url() ?>aceadmin/css/bootstrap-offset-right.css" />
    <link rel="stylesheet" href="https://code.getmdl.io/1.3.0/material.blue-deep_purple.min.css" />
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,700" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>aceadmin/css/style.css" />
...
<body>
                    ...
                    <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img class="img-responsive center-block" src="<?php echo base_url() ?>aceadmin/img/step1.png" alt="step1">
                            ...
                            <div class="item">
                                <img class="img-responsive center-block" src="<?php echo base_url() ?>aceadmin/img/step2.png" alt="step2">
                                <div class="item-content">
                            ...
                            <div class="item">
                                <img class="img-responsive center-block" src="<?php echo base_url() ?>aceadmin/img/step3.png" alt="step3">
                                <div class="item-content">
                        ...
                        <form action="<?= site_url('auth/process') ?>" method="post">
                            ...
                            <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" name="username" type="text" id="emailAddress" required autofocus>
                            ...
                            <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">
                                <button class="btn lt-register-btn" name="login">login <i class="icon-right "></i></button>
                            </div>
                        </form>
                        <!--register form-->
                    </div>
    ...
    <script src="<?php echo base_url() ?>aceadmin/node_modules/jquery/dist/jquery.min.js "></script>
    <script src="<?php echo base_url() ?>aceadmin/node_modules/bootstrap/dist/js/bootstrap.min.js "></script>
    <script src="<?php echo base_url() ?>aceadmin/libs/mdl/material.min.js "></script>
