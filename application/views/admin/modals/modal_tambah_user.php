<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-user" method="POST">
    <div class="input-group form-group">
      ...
      <select name="nim" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%">
        <?php
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="tipeuser" name="roleid" aria-describedby="sizing-addon2">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="profile" name="profile" value=mahasiswa1.jpg aria-describedby="sizing-addon2">
    </div>
