...
class Jurusan extends AUTH_Controller
{
  ...
  public function index()
  {
    ...
    $data['modal_tambah_jurusan'] = show_my_modal('admin/modals/modal_tambah_jurusan', 'tambah-jurusan', $data);

    $this->template->views('admin/jurusan/home', $data);
  }

  public function tampil()
  {
    $data['dataJurusan'] = $this->Mjurusan->select_all();
    $this->load->view('admin/jurusan/list_data', $data);
  }
  ...
  public function update()
  {
    ...
    echo show_my_modal('admin/modals/modal_update_jurusan', 'update-jurusan', $data);
  }
