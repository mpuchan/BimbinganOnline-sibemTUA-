...
class Mjurusan extends CI_Model
{
  ...
  {
    $sql = "INSERT INTO jurusan VALUES('" . $data['kode_jurusan'] . "','" . $data['namajurusan'] . "','" . $data['nip'] . "','" . $data['namakajur'] . "','" . $data['notelp'] . "')";
  ...
  public function update($data)
  {
    $sql = "UPDATE jurusan SET namajurusan='" . $data['namajurusan'] . "', 
        nip='" . $data['nip'] . "', namakajur='" . $data['namakajur'] . "', notelp='" . $data['notelp'] . "' WHERE kode_jurusan='" . $data['kode_jurusan'] . "'";
